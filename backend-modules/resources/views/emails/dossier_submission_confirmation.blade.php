...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Nous vous confirmons que votre dossier a été soumis avec succès pour le département <strong>{{ $department }}</strong> (Cycle: <strong>{{ $cycle_name }}</strong>) pour l'année académique <strong>{{ $academic_year }}</strong> {{ $study_level ? ", au niveau d'étude" : "" }} <strong>{{ $study_level }}</strong>.</p>
            <div class="highlight">
