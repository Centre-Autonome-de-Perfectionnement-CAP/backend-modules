{{-- resources/views/emails/attestation-confirmation.blade.php --}}
{{-- Variables : $reference, $type, $studentName, $submittedAt, $paymentMethod, $paymentRef --}}
<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Confirmation de demande — CAP-EPAC</title>
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p class="text-muted">
        Votre demande d'attestation a été prise en compte par nos services.
          ...
          <td class="value">
            @php
              $labels = [
                ...
                'attestation_succes'      => 'Attestation de Succès',
              ];
            @endphp
            {{ $labels[$type] ?? $type }}
          </td>
