{{-- resources/views/core/emails/demande-ready.blade.php --}}
<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Document prêt — {{ $reference }}</title>
  <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .notice { background:#f0fdf4; border:1px solid #bbf7d0; border-radius:6px; padding:16px; color:#166534; font-size:14px; margin-bottom:24px; }
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <p class="text">
        Nous avons le plaisir de vous informer que votre demande de document a été traitée avec succès.
      </p>
      ...
      <div class="notice">
        <strong>Votre document est désormais disponible.</strong><br>
        Vous êtes invité(e) à vous présenter au Secrétariat du CAP-EPAC durant les heures d'ouverture pour procéder à son retrait.
      </div>

      <p class="text" style="font-size:14px;">
        <em>Veuillez vous munir de votre carte d'étudiant ou d'une pièce d'identité, ainsi que de votre quittance originale de paiement lors de votre passage.</em>
      </p>
    </div>
    <div class="footer">
