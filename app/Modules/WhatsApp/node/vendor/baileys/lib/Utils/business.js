 ...
 */
export async function uploadingNecessaryImagesOfProduct(product, waUploadToServer, timeoutMs = 30_000) {
    product = {
        ...product,
 ...
 * Uploads images not already uploaded to WA's servers
 */
export const uploadingNecessaryImages = async (images, waUploadToServer, timeoutMs = 30_000) => {
